    ...
    >
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
          Building <span className="text-[#FFD700]">Websites & Apps</span>
          That Define the <span className="text-[#FFD700]">Next Level</span>
        </h1>
        ...
        <a
          href="#contact"
          className="bg-slate-950 transition  border border-[#FFD700] text-white px-6 py-3 rounded-lg text-sm font-medium shadow-md"
        >
          Free Consultation
        </a>
      </motion.div>
